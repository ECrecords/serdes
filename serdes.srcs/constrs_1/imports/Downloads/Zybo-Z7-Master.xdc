...
set_property -dict {PACKAGE_PIN F17 IOSTANDARD LVCMOS33} [get_ports { LOAD }];
...
##Pmod Header JD
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports { SERIAL_DATA }]
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports tx_valid]
...
##Pmod Header JE
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { tx_serial_data }]; #IO_L4P_T0_34 Sch=je[1]
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { tx_valid }]; #IO_L18N_T2_34 Sch=je[2]
